...
public class ObjectFactory {
	...
	/**
	 * Create an instance of {@link GetQyiPayDataResponse }
	 * 
	 */
	public GetQyiPayDataResponse createGetQyiPayDataResponse() {
		return new GetQyiPayDataResponse();
	}

	/**
	 * Create an instance of {@link GetQyiPayData }
	 * 
	 */
	public GetQyiPayData createGetQyiPayData() {
		return new GetQyiPayData();
	}
