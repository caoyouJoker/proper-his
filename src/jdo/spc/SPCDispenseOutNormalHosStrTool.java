...
public class SPCDispenseOutNormalHosStrTool extends TJDODBTool {
	
	 /** 实例*/
    public static SPCDispenseOutNormalHosStrTool instanceObject;

    /**得到实例*/
    public static SPCDispenseOutNormalHosStrTool getInstance() {
        if (instanceObject == null)
            instanceObject = new SPCDispenseOutNormalHosStrTool();
