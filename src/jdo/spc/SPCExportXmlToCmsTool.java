...
public class SPCExportXmlToCmsTool extends TJDOTool {
    /**
     * 实例
     */
    public static SPCExportXmlToCmsTool instanceObject;
    /**
     * 得到实例
     * @return ClinicRoomTool
     */
    public static SPCExportXmlToCmsTool getInstance() {
        if (instanceObject == null)
            instanceObject = new SPCExportXmlToCmsTool();
