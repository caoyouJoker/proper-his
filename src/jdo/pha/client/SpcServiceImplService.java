 ...
 * 2012-12-28T14:02:35.203+08:00
 * Generated source version: 2.5.2
 * 
 */
@WebServiceClient(name = "SpcServiceImplService", 
                  wsdlLocation = "http://172.20.116.105:8080/webgy/services/spcService?wsdl",
...
public class SpcServiceImplService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("http://172.20.116.105:8080/webgy/services/spcService?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SpcServiceImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://172.20.116.105:8080/webgy/services/spcService?wsdl");
        }
        WSDL_LOCATION = url;
    }
