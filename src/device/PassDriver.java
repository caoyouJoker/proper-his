...
public class PassDriver {
	static {
    System.loadLibrary("PassDriver"); //载入dll
    RegisterServer();
  }
   ...
   */
  public native static int PassGetWarn1(String DrugUniqueCode);
   ...
   * @return int 暂无意义
   */
  public native static int PassSetWarnDrug1(String DrugUniqueCode);
...
//    f.setVisible(true);
    ...
    //  {
        ...
        System.out.println("PassSetControlParam()" + PassSetControlParam(1,2,1,2,1));
        PassSetPatientInfo("A1","1","张张","男","2001-04-05","","","","","");
        PassSetRecipeInfo("1101190000161", //医嘱唯一码
                       "1PA00001", //药品编码
                       "氯化钾", //药品名称
                       "999999999999.0", //每次用量
                       "撒旦", //剂量单位
                       ...
                       "口服", //给药途径中文名称
                       "", //成组医嘱标志(必须传)
                       "1","admin/系统管理员"); //是否为临时医嘱
        PassSetRecipeInfo("1101190000162", //医嘱唯一码
                       "1IAC0002", //药品编码
                       "螺内酯", //药品名称
                       "99999999999.0", //每次用量
                       "1撒旦17", //剂量单位
                       ...
                       "1","admin/系统管理员"); //是否为临时医嘱
          PassDoCommand(33);
//          System.out.println("PassGetWarn()"+this.PassGetWarn("1"));
//          System.out.println("PassSetWarnDrug()" + this.PassSetWarnDrug("1"));
//          System.out.println("PassDoCommand()" + this.PassDoCommand(6));
//          System.out.println("PassSetQueryDrug()" + PassSetQueryDrug("1W000011","25%葡萄糖酸钙针","",""));
//          this.PassDoCommand(106);
//          System.out.println("PassGetState()"+this.PassGetState("207"));
//          System.out.println("PassDoCommand()" + PassDoCommand(207));
...
//    close();
//    System.out.println("PassGetState()" + PassGetState("24"));
//    System.out.println("PassGetWarn() "+PassGetWarn("" + 1));
  }
