 ...
 * @version 1.0
 */
public class OPBRECTPrintReportToolForHRM_puhua implements IReport {
    ...
    public TParm getReportParm(TParm parm) {
        parm.setData("CIRCLE", "TEXT", "○");//add by wanglong 20130408
    ...
    private TParm setUncertainItems(TParm oneReceiptParm) {//add by wanglong 20121217
        ...
        if (oneReceiptParm.existGroup("CHARGE11")&&(oneReceiptParm.getDouble("CHARGE11", "TEXT")!=0)) {// 体检费 add by wanglong 20130123
            oneReceiptParm.setData("ITEM"+num, "TEXT", descParm.getValue("CHARGE11"));
