 ...
 * <p>Title: 护嘱分类下拉区域</p>
 *
 * <p>Description: 护嘱分类下拉区域</p>
 *
 * <p>Copyright: Copyright (c) Liu dongyang 2008</p>
 *
 * <p>Company: JavaHis</p>
 *
 * @author wangl 2011.05.28
 * @version 1.0
 */
public class TextFormatCLPNursetype
    extends TTextFormat {
    /**
     * 护嘱分类
     */
    private String classFlg; //CLASS_FLG
    /**
     * 区域
     */
    ...
    public String getPopupMenuSQL() {
        ...
        String classFlgTemp = TypeTool.getString(getTagValue(getClassFlg()));
        if (classFlgTemp != null && classFlgTemp.length() > 0)
            sb.append(" CLASS_FLG = '" + classFlgTemp + "' ");
    ...
    public void getEnlargeAttributes(TAttributeList data) {
        ...
        data.add(new TAttribute("ClassFlg", "String", "", "Left"));
    ...
    public void setAttribute(String name, String value) {
        if ("ClassFlg".equalsIgnoreCase(name)) {
            setClassFlg(value);
