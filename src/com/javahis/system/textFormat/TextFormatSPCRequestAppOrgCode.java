...
public class TextFormatSPCRequestAppOrgCode extends TTextFormat {
	...
	public String getPopupMenuSQL() {
		String sql = "  SELECT  DEPT_CODE AS ID,DEPT_CHN_DESC AS NAME,PY1,PY2  FROM SYS_DEPT " +
					 "  UNION " +
