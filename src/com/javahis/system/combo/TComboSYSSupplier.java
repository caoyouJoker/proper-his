 ...
 * @version 1.0
 */
public class TComboSYSSupplier extends TComboBox{
    /**
     * 停止采购注记
     */
   ...
   public void onQuery()
   {
       ...
       parm.setDataN("SUP_STOP_FLG",getTagValue(getSupStopFlg()));
   ...
   {
       return "sys\\SYSSupplierModule.x";
   }
