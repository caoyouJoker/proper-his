 ...
 * @version 1.0
 */
public class STAPackageChooseControl extends TControl {
    ...
    public void onInitTree() {
        ...
        String sql =
                "SELECT PACKAGE_CODE, PACKAGE_DESC FROM STA_SMSPACKAGEM WHERE ACTIVE_FLG = 'Y'";
    ...
    public void initChildrenNode(TTreeNode parentNode, String packageCode) {
        ...
        String sql =
                "SELECT A.USER_ID, B.USER_NAME, A.TEL FROM STA_SMSPACKAGED A, SYS_OPERATOR B "
