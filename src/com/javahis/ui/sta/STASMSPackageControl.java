...
/**
 * <p>Title: 医疗日报短信套餐设定 </p>
 *
 * <p>Description: 医疗日报短信套餐设定 </p>
 *
 ...
 * @version 1.0
 */
public class STASMSPackageControl extends TControl{

    // 短信套餐主档初始化SQL
    public static final String INIT_PACKAGE_MAIN = " SELECT * FROM STA_SMSPACKAGEM ";
    // 短信套餐细档初始化SQL
    public static final String INIT_PACKAGE_DETAIL = " SELECT * FROM STA_SMSPACKAGED WHERE PACKAGE_CODE ='#' ";
    private TTable tableM, tableD;
    private TDataStore main; // 套餐主项datastore
    private STASMSPackageD detail; // 套餐细相datastore
    ...
    public boolean onDetailValueChanged(TTableNode tNode) {
        ...
        if ("USER_ID".equalsIgnoreCase(colName)) {
            ...
            TParm result = STASMSTool.getInstance().getOperatorInfo(userId);
    ...
    public void onNew() {
        ...
        String packCode = STASMSTool.getInstance().getNewPackCode();
    ...
    public void onDelete() {
        ...
        if ("TABLE_M".equalsIgnoreCase(tableName)) {
            ...
            TParm result = TIOM_AppServer.executeAction("action.sta.STASMSAction", "onSave", inParm);
