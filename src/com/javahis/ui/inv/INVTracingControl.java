...
//        DecimalFormat ff = new DecimalFormat("######0.00");
        ...
        //科室          
        if (!deptcode.equals("")) {  
        //2014-02-10注掉            SQL.append(" AND A.ORG_CODE='" + deptcode + "'");
        ...
        for(int i=0;i<result.getCount("MR_NO");i++){
        	...
        	if(result.getRow(i).getData("DEPT_CODE").toString().equals("030101")){
        		result.setData("DEPT_ABS_DESC", i, "林文华");
//        		result.getRow(i).setData("DEPT_ABS_DESC", i, "林文华");
        	}else if(result.getRow(i).getData("DEPT_CODE").toString().equals("030102")){
        		result.setData("DEPT_ABS_DESC", i, "齐向前");
//        		result.getRow(i).setData("DEPT_ABS_DESC", i, "齐向前");
        	}else if(result.getRow(i).getData("DEPT_CODE").toString().equals("030103")){
        		result.setData("DEPT_ABS_DESC", i, "张健");
 //       		result.getRow(i).setData("DEPT_ABS_DESC", i, "张健");
        	}else if(result.getRow(i).getData("DEPT_CODE").toString().equals("030104")){
        		result.setData("DEPT_ABS_DESC", i, "任自文");
 //       		result.getRow(i).setData("DEPT_ABS_DESC", i, "任自文");
        	}else if(result.getRow(i).getData("DEPT_CODE").toString().equals("030106")){
        		result.setData("DEPT_ABS_DESC", i, "张宏艳");
  //      		result.getRow(i).setData("DEPT_ABS_DESC", i, "张宏艳");
        	}else if(result.getRow(i).getData("DEPT_CODE").toString().equals("0304")){
        		result.setData("DEPT_ABS_DESC", i, "宋昱");
  //      		result.getRow(i).setData("DEPT_ABS_DESC", i, "宋昱");
        	}else {
        		result.setData("DEPT_ABS_DESC", i, "刘洪");
  //      		result.getRow(i).setData("DEPT_ABS_DESC", i, "刘洪");
        	}
