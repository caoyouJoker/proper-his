...
public class INVSQL {
    ...
    public static String getINDSysParm() {
        return
            ...
            +
            "WNHI_COSTRATE,WGOV_COSTRATE,UPDATE_WRETAIL_FLG,MANUAL_TYPE,OPT_USER,"
...
//    	+ " AND ACTIVE_FLG = 'Y' ";
    ...
    public static String getVerifyinDByNo(String verifyin_no) {
        return
            ...
            + "OPT_DATE, OPT_TERM, MAN_CODE,BATCH_SEQ "//加入验收时存入库中的BATCH_SEQ luahi 2012-01-01 modify
...
//            frozen_date + "' ORDER BY A.ORDER_CODE";
    ...
    public static String getIndStockMInfo(String org_code, String order_code,
                                          String material_loc_code) {
        String sql =
            "SELECT A.ORDER_CODE, C.ORDER_DESC, A.MATERIAL_LOC_CODE, A.DISPENSE_FLG, "
...
//    	System.out.println("----------sql: "+sql);
    ...
    public static String getPurOrderDSqlByNo(String purorder_no)
    {
      String sql = " SELECT A.SUP_CODE,B.ORDER_CODE,C.ORDER_DESC,C.SPECIFICATION, D.UNIT_CHN_DESC, " +
      		       ...
      		       "WHERE A.PURORDER_NO='" + purorder_no + "' AND A.PURORDER_NO=B.PURORDER_NO AND B.ORDER_CODE=C.ORDER_CODE AND B.BILL_UNIT=D.UNIT_CODE";
      return sql;
    }
