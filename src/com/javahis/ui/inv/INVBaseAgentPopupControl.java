 ...
 * @version 1.0
 */
public class INVBaseAgentPopupControl extends TControl {

    public INVBaseAgentPopupControl() {
   }
   ...
   public void filter() {
       TParm result = new TParm(TJDODBTool.getInstance().select(
           INVSQL.getInvBaseAgentPopup(getValueString("EDIT")
                              .toUpperCase())));
       table.setParmValue(result);
   }  
