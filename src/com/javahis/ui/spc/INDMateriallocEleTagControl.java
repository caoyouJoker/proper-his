...
public class INDMateriallocEleTagControl
    extends TControl {
    ...
    TTable tblPat;
    public INDMateriallocEleTagControl() {
        super();
    }
     ...
     */
    public void onInit() {
        // 初始画面数据SELECT_FLG;NAME;PATH
    	TParm parm = new TParm();
    	parm.setData("SELECT_FLG", 0,true);
    	parm.setData("NAME", 0, "药品货位与电子标签对应关系.XML");
    	parm.setData("PATH", 0, "C:/UPLOAD/ORDERCODE20121015.XML");
...
//        System.out.println("--查询数据: " + resuTParm);
    ...
    private void initPage() {
    	//得到上传文件路径
    	 String path ="c:/temp";// getFilePath();
