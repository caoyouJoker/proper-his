 ...
 * @version 1.0
 */
public class INDVerifyinQueryAcntControl
    extends TControl {
    ...
    public void onQuery() {
        ...
        if (this.getRadioButton("RadioButton1").isSelected()) {
            resultM = IndVerifyinDTool.getInstance().onQueryVerifyinBuyMasterAcnt(
                parm);//wanglong modify 20150202
            resultD = IndVerifyinDTool.getInstance().onQueryVerifyinBuyDetailAcnt(
                parm);//wanglong modify 20150202
        }
        else {
            resultM = IndVerifyinDTool.getInstance().onQueryVerifyinGiftMasterAcnt(
                parm);//wanglong modify 20150202
            resultD = IndVerifyinDTool.getInstance().onQueryVerifyinGiftDetailAcnt(
                parm);//wanglong modify 20150202
        }
