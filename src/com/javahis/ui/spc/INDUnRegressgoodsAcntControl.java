...
public class INDUnRegressgoodsAcntControl
    extends TControl {
    ...
    public INDUnRegressgoodsAcntControl() {
        super();
    }
...
//        resultParm = result;
        ...
        String sql = " SELECT 'N' AS SELECT_FLG, B.VERIFYIN_NO, B.VERIFYIN_DATE, A.ORDER_CODE, C.SPECIFICATION,"+
  		             ...
  		             " (SELECT VERIFYIN_NO, VERSEQ_NO,SUM (QTY) AS QTY  FROM SPC_REGRESSGOODSD GROUP BY VERIFYIN_NO, VERSEQ_NO) E "+
...
//		}
    ...
    private void initPage() {
        ...
        // 根据供应商和科室查询已完成验收单号
        TParm parm = IndVerifyinMTool.getInstance().onQueryDoneVerByOrgAndSupAcnt(
            org_code, sup_code);//wanglong modify 20150423
