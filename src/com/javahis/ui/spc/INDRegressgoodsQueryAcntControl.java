 ...
 * @version 1.0
 */
public class INDRegressgoodsQueryAcntControl
    extends TControl {
...
//        }
        ...
        if (this.getRadioButton("RadioButton1").isSelected()) {
            result = IndRegressgoodsMTool.getInstance().onQueryRegressgoodsAcnt(parm);//wanglong modify 20150202
        }
        else {
            result = IndRegressgoodsMTool.getInstance().onQueryRegressgoodsCheckAcnt(parm);//wanglong modify 20150202
        }
