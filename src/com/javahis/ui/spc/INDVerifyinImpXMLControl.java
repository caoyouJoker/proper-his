...
/**
 * <p>
 * Title: 导入电子标签和药品货位关系Control
 * </p>
 *
 * <p>
 * Description: 导入电子标签和药品货位关系Control
 * </p>
 *
 * <p>
...
public class INDVerifyinImpXMLControl
    ...
    // 药品种类 Y麻精，N 非麻精
    private String drogType;
    private static final String DROG_Y_FILE_PATH_STR = "gen";
    private static final String DROG_N_FILE_PATH_STR = "drog";
    private static final String FILE_PATH = "c:/hisupload";
    private static final String FILE_PATH_TAG = "/";
    private static final String DROG_TYPE_N = "N";
    TTable tblPat;
    ...
    public void onInit() {
		...
		drogType = parm.getValue("DROG_TYPE");    	
        initPage();
    }
...
//         System.out.println("parm:"+parm);
    ...
    private String getFilePath(){
    	//默认路径
    	String syspath= Operator.getIP();
    	String filePath = FILE_PATH;
    	if(DROG_TYPE_N.equals(drogType)){//非麻精
    		filePath = filePath + FILE_PATH_TAG + DROG_N_FILE_PATH_STR;
    	}else {//麻精
    		filePath = filePath + FILE_PATH_TAG + DROG_Y_FILE_PATH_STR;
		}
