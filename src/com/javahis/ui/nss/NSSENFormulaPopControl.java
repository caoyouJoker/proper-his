...
/**
 * <p>Title: 肠内营养配方明细弹出界面</p>
 *
 * <p>Description: 肠内营养配方明细弹出界面</p>
 *
 * <p>Copyright: Copyright (c) 2015</p>
 *
 * <p>Company: Javahis</p>
 *
 * @author wangb 2015.3.18
 * @version 1.0
 */
public class NSSENFormulaPopControl extends TControl {
	...
	public void initParamenter() {
		...
		TParm result = new TParm(TJDODBTool.getInstance().select(
				NSSEnteralNutritionTool.getInstance().queryENFormulaPopSql("")));
