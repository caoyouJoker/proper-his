...
public class SYSCtrlDrugClassUIControl
    extends TControl {
    ...
    public SYSCtrlDrugClassUIControl() {
    }
    ...
    public void onSave() {
        ...
        if ("save".equals(action)) {
            ...
            table.setItem(row, "PSYCHOPHA_FLG", getValueString("PSYCHOPHA_FLG"));
    ...
    public void onClear() {
        ...
        String clearString =
            ...
            +
            "PRNSPCFORM_FLG;CTRL_FLG;NARCOTIC_FLG;TOXICANT_FLG;PSYCHOPHA_FLG;"
