 ...
 * @version add by yangjj 20151020
 */
public class LEDEXECUI extends JWindow{
    private int otherX;
    private int otherY;
    private int textX;
    /**
   ...
   private String stationCode="";
     ...
     * @param owner Frame
     */
    public LEDEXECUI(Frame owner,Object control,Object parm) {
        super(owner);
...
//        System.out.println("主窗体宽度:" + this.mainWidth);
     ...
     * ========pangben 2011-11-10
     */
    public LEDEXECUI(Frame owner,Object control,Object parm,boolean flg) {
        super(owner);
        initTemp(owner,control,parm);
        jbInitOne();
    }
...
//          System.out.println("双击");
  ...
  public void doubleClick(){
      ...
      //停止声音
      stopSound();
      this.control.openInwExecWindow(action);
  }
  /**
   * 关闭
   */
...
//      System.out.println("6");
  ...
  public void onMessageOne(Timestamp time,String id,String message){
      ...
      String msg0 = message.substring(0, 7);
      String msg1 = message.substring(7,message.length()-1);
      if("INWEXEC".equals(msg0)){
    	  magess.append("未来1小时需要执行:"+msg1);
          //启动颜色线程
          changeTableRowColor();
          //启用滚动文字
          startMoveThread();
