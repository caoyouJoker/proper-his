...
/**
 *
 * <p>Title:其他报告显示医嘱设置界面 </p>
 *
 * <p>Description:其他报告显示医嘱设置界面 </p>
 *
 * <p>Copyright: Copyright (c) 2018 </p>
 *
 * <p>Company: ProperSoft </p>
 *
 * @author zhanglei 2018.01.12
 * @version 5.0
 */
public class SYSParmControl extends TControl {
...
//        }
        String sql =
                "SELECT A.ORDER_CODE,B.ORDER_DESC FROM SYS_RISORDER A,SYS_FEE B WHERE A.ORDER_CODE=B.ORDER_CODE";
...
//        deptTableParm.setCount(deptTableParm.getCount("DEPT_CODE"));
        ...
        sql = StringTool.copyArray(sql, new String[]{"DELETE FROM SYS_RISORDER" });
...
//        }
        String orderTemplateSql =
                "INSERT INTO SYS_RISORDER(ORDER_CODE,OPT_USER,OPT_DATE,OPT_TERM) VALUES(!,@,#,&)";
...
//            System.out.println("111111---------sql["+i+"]--------"+sql[i]);
//        }
    ...
    public void onClear() {
        ...
        clearValue("ORDER_CODE;ORDER_DESC");
