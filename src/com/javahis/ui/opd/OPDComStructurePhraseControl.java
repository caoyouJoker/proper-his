 ...
 * @version 1.0
 */
public class OPDComStructurePhraseControl
    extends TControl {
    ...
    private TParm getNodes() {
        TParm result = new TParm(this.getDBTool().select("SELECT CLASS_CODE,PHRASE_CODE,LEAF_FLG,PARENT_CLASS_CODE FROM OPD_COMTEMPLATE_PHRASE ORDER BY CLASS_CODE,SEQ"));
        return result;
    }
