...
//                parm.setData("BATCH_SEQ", count, batch_seq);
                ...
                parm.setData("SUP_ORDER_CODE", count, supOrderCode);
                dataStore.setItem(newrows[i], "ACTUAL_QTY", actual_qty);
                parm.setData("ACTUAL_QTY", count, actual_qty);
              //20150723 wangjc add end
                count++;
            }
            // 得到dataStore的更新SQL
...
//                    System.out.println("======"+batchSeqStr);
                  ...
                  //20150723 wangjc add start
                    String supOrderCode = dataStore.getItemString(i, "SUP_ORDER_CODE");
