...
public class INDShortageMonitorControl extends TControl {
	...
	public INDShortageMonitorControl() {
	}
...
//		//String sql1 = "SELECT B.ORDER_CODE,B.ORDER_DESC FROM IND_VERIFYIND A, SYS_FEE B WHERE A.ORDER_CODE = B.ORDER_CODE AND B.ORDER_CODE IN ('2B015017','2B015018','2B015019','2B015021','2B015023','2B015022','2B015024') GROUP BY B.ORDER_CODE,B.ORDER_DESC ";
//		String sql1 ="SELECT C.ORDER_CODE,C.ORDER_DESC,C.MONITOR_TYPE,C.ENABLE_FLG FROM IND_MONITOR_MED C WHERE C.MONITOR_TYPE='LAC' AND C.ENABLE_FLG='Y'" ;
...
//				+ opt_date
//                +" AND A.ORDER_CODE IN (SELECT ORDER_CODE FROM IND_MONITOR_MED WHERE MONITOR_TYPE = 'LAC' AND ENABLE_FLG='Y') "
...
//				+ "AND A.ORDER_CODE = C.ORDER_CODE "
	...
	public void onExport() {
		...
		ExportExcelUtil.getInstance().exportExcel(table, "短缺药品统计");
	}
	...
	public void onPrint() {
		...
		if (table.getRowCount() <= 0) {
			...
			this.openPrintDialog(
					"%ROOT%\\config\\prt\\IND\\INDShortageMonitor.jhw", data);
		}
