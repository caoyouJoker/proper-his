...
//		System.out.println("55555555555");
		...
		// 以及单元格内容为test
		Label title = new Label(0, 0, "手术部位医院感染病例", formatHeader);
		Label Detail = new Label(0, 1, "医院名称：泰达国际心血管病医院",
				formatDetail);

		Label DetailHead1 = new Label(0, 2, "患者基本信息", formatDetailHead1);
		Label DetailHead2 = new Label(3, 2, "手术情况", formatDetailHead2);
		Label DetailHead3 = new Label(17, 2, "手术应用抗菌药物", formatDetailHead3);
