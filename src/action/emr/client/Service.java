 ...
 * 2016-02-02T12:02:34.185+08:00
 * Generated source version: 3.0.7
 * 
 */
@WebServiceClient(name = "Service", 
                  wsdlLocation = "http://172.20.10.152/Service.asmx?wsdl",
                  targetNamespace = "http://172.20.10.152/signpdf/") 
public class Service extends javax.xml.ws.Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://172.20.10.152/signpdf/", "Service");
    public final static QName ServiceSoap = new QName("http://172.20.10.152/signpdf/", "ServiceSoap");
    public final static QName ServiceSoap12 = new QName("http://172.20.10.152/signpdf/", "ServiceSoap12");
    static {
        URL url = null;
        try {
            url = new URL("http://172.20.10.152/Service.asmx?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(Service.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://172.20.10.152/Service.asmx?wsdl");
        }
        WSDL_LOCATION = url;
    }
