...
public interface SpcOdiService {
    ...
    @WebResult(name = "return", targetNamespace = "")
    @RequestWrapper(localName = "examineBatch", targetNamespace = "http://services.spc.action/", className = "action.udd.client.ExamineBatch")
    @WebMethod
    @ResponseWrapper(localName = "examineBatchResponse", targetNamespace = "http://services.spc.action/", className = "action.udd.client.ExamineBatchResponse")
    public java.lang.String examineBatch(
        @WebParam(name = "arg0", targetNamespace = "")
        action.udd.client.SpcOdiDspnms arg0  
    );
    
    @WebResult(name = "return", targetNamespace = "")
    @RequestWrapper(localName = "onCheckStockQtyBatch", targetNamespace = "http://services.spc.action/", className = "action.udd.client.onCheckStockQtyBatch")
    @WebMethod
    @ResponseWrapper(localName = "onCheckStockQtyBatchResponse", targetNamespace = "http://services.spc.action/", className = "action.udd.client.onCheckStockQtyBatchResponse")
    public java.lang.String onCheckStockQtyBatch(
        @WebParam(name = "arg0", targetNamespace = "")
        action.udd.client.SpcOdiDspnms arg0   
    );
    @WebResult(name = "return", targetNamespace = "")
    @RequestWrapper(localName = "onQueryBatch", targetNamespace = "http://services.spc.action/", className = "action.udd.client.onQueryBatch")
    @WebMethod
    @ResponseWrapper(localName = "onQueryBatchResponse", targetNamespace = "http://services.spc.action/", className = "action.udd.client.onQueryBatchResponse")
    public java.lang.String onQueryBatch(
        @WebParam(name = "arg0", targetNamespace = "")
        action.udd.client.SpcOdiDspnms arg0
    );
