...
Module.item=insert;updateIn;query;delete;queryBloodCross;queryBloodStock;getApplyInfo;ApplyUpdateBloodCross;&
ApplyUpdateBloodOut;getSumTot;queryBloodStockStatus;queryBloodQtyStock;queryMonthStock;queryBloodCrossExceptOut;&
ApplyUpdateBloodCrossRecheckOnBMS_APPLYM;ApplyUpdateBloodCrossRecheckOnBMS_BLOOD;queryBloodStockOrderBy
...
//库存查询
queryBloodStockOrderBy.Type=TSQL
queryBloodStockOrderBy.SQL=SELECT BLOOD_NO, RH_FLG, BLD_CODE, BLDRESU_CODE, SUBCAT_CODE, &
			   IN_DATE, BLD_TYPE, SHIT_FLG, END_DATE, IN_PRICE, BLOOD_VOL, &
		 	   ORG_BARCODE, STATE_CODE, APPLY_NO, MR_NO, IPD_NO, &
		 	   CASE_NO, ID_NO, USE_DATE, CROSS_MATCH_L, CROSS_MATCH_S, & 
   		 	   ANTI_A, ANTI_B, RESULT, TEST_DATE, TEST_USER, &
   		 	   ...
   		 	   TRAN_DATE FROM BMS_BLOOD &
   		 	   WHERE END_DATE > SYSDATE AND STATE_CODE = '0'  &
                          ORDER BY  END_DATE, BLOOD_NO
queryBloodStockOrderBy.ITEM=BLOOD_NO;BLD_CODE;BLD_TYPE;SUBCAT_CODE;END_DATE
queryBloodStockOrderBy.BLOOD_NO=BLOOD_NO=<BLOOD_NO>
queryBloodStockOrderBy.BLD_CODE=BLD_CODE=<BLD_CODE>
queryBloodStockOrderBy.BLD_TYPE=BLD_TYPE=<BLD_TYPE>
queryBloodStockOrderBy.SUBCAT_CODE=SUBCAT_CODE=<SUBCAT_CODE>
queryBloodStockOrderBy.END_DATE=END_DATE=<END_DATE>
queryBloodStockOrderBy.Debug=N
...
ApplyUpdateBloodCross.SQL=UPDATE BMS_BLOOD SET &
				 ...
				 ANTI_B=<ANTI_B>, RESULT=<RESULT>, SHIT_FLG=<SHIT_FLG>,TEST_USER=<TEST_USER>, OPT_USER=<OPT_USER>, OPT_DATE=<OPT_DATE>, &
...
ApplyUpdateBloodOut.SQL=UPDATE BMS_BLOOD SET &
				 STATE_CODE=<STATE_CODE>, OUT_NO=<OUT_NO>, OUT_DATE=<OUT_DATE>, OUT_USER=<OUT_USER>, TAKE_NO=<TAKE_NO>, &
...
queryBloodCrossExceptOut.SQL=SELECT BLOOD_NO, RH_FLG, BLD_CODE, BLDRESU_CODE, SUBCAT_CODE, &
			   IN_DATE, BLD_TYPE, SHIT_FLG, END_DATE, IN_PRICE, BLOOD_VOL, &
		 	   ...
		 	   CASE_NO, ID_NO, USE_DATE, CROSS_MATCH_L, CROSS_MATCH_S, & 
   		 	   ...
   		 	   PRE_U, PRE_D, T, P, R, &
   		 	   WORK_USER, OUT_NO, OUT_DATE, OUT_USER, TRAN_RESN, &
   		 	   TRAN_DATE,RECHECK_TIME,RECHECK_USER FROM BMS_BLOOD &
...
//更新BMS_APPLYM交叉配血审核信息
ApplyUpdateBloodCrossRecheckOnBMS_APPLYM.Type=TSQL 
ApplyUpdateBloodCrossRecheckOnBMS_APPLYM.SQL=UPDATE BMS_APPLYM SET RECHECK_USER = <RECHECK_USER> , RECHECK_TIME = TO_DATE(<RECHECK_TIME>, 'YYYYMMDDHH24MISS') WHERE APPLY_NO = <APPLY_NO>
ApplyUpdateBloodCrossRecheckOnBMS_APPLYM.Debug=N

//更新BMS_BLOOD交叉配血审核信息
ApplyUpdateBloodCrossRecheckOnBMS_BLOOD.Type=TSQL
ApplyUpdateBloodCrossRecheckOnBMS_BLOOD.SQL=UPDATE BMS_BLOOD SET RECHECK_USER = <RECHECK_USER> , RECHECK_TIME = TO_DATE(<RECHECK_TIME>, 'YYYYMMDDHH24MISS') WHERE APPLY_NO = <APPLY_NO> AND BLOOD_NO = <BLOOD_NO>
ApplyUpdateBloodCrossRecheckOnBMS_BLOOD.Debug=N
