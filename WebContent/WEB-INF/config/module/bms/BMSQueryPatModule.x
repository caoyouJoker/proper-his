...
queryOE.SQL=SELECT DISTINCT A.ADM_TYPE, A.ADM_DATE, A.CASE_NO, C.USER_NAME, &
		 ...
		 A.ADM_STATUS, A.REGCAN_USER, A.SEE_DR_FLG, A.DEPT_CODE, A.CTZ1_CODE, A.REGCAN_DATE,A.MR_NO, B.BLOOD_RH_TYPE , B.BLOOD_TYPE &
...
queryI.SQL=SELECT DISTINCT 'I' AS ADM_TYPE, A.IN_DATE, A.CASE_NO, C.USER_NAME, &
		  ...
		  B.BLOOD_RH_TYPE , B.BLOOD_TYPE,A.STATION_CODE, F.STATION_DESC &
