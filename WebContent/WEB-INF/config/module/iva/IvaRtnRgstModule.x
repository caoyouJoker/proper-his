Module.item=onInsertM;onUpdateM;onInsertD;onUpdateD;onDeleteM;onDeleteD;onUpdateRtnCfmM;onUpdateRtnCfmD;getUDDRtnData;onCancleDisM;onCancleDisD;onInsertMRtn
...
onInsertM.SQL=INSERT INTO ODI_DSPNM (CASE_NO,   ORDER_NO,  ORDER_SEQ, START_DTTM, END_DTTM,ORDER_CODE,  ORDER_DESC, DC_TOT,   RTN_DOSAGE_QTY,  RTN_DOSAGE_UNIT,  TRANSMIT_RSN_CODE,  DSPN_USER, DSPN_DATE,OPT_DATE,OPT_USER,  OPT_TERM,DSPN_KIND,EXEC_DEPT_CODE,       MR_NO,STATION_CODE,   BED_NO,  IPD_NO,DISPENSE_QTY,DISPENSE_UNIT,      DOSE_TYPE,GIVEBOX_FLG,     OWN_PRICE,PHA_TYPE,ROUTE_CODE,RTN_NO,RTN_NO_SEQ,ORDER_CAT1_CODE,REGION_CODE,DEPT_CODE, CAT1_TYPE, VS_DR_CODE &
                            ...
                            ,PARENT_CASE_NO,PARENT_ORDER_NO,PARENT_ORDER_SEQ,PARENT_START_DTTM,RT_KIND,IVA_FLG &
			    ) &
                           VALUES(  <CASE_NO>,<ORDER_NO>,<ORDER_SEQ>,<START_DTTM>,<END_DTTM>,<ORDER_CODE>,<ORDER_DESC>,<DC_TOT>,<RTN_DOSAGE_QTY>,<RTN_DOSAGE_UNIT>,<TRANSMIT_RSN_CODE>,<DSPN_USER>,SYSDATE,  SYSDATE,<OPT_USER>,<OPT_TERM>,<RX_KIND>,<EXEC_DEPT_CODE>,<MR_NO>,<STATION_CODE>,<BED_NO>,<IPD_NO>,<DISPENSE_QTY>,<DISPENSE_UNIT>,<DOSE_TYPE>,<GIVEBOX_FLG>,<OWN_PRICE>,<PHA_TYPE>,<ROUTE_CODE>,<RTN_NO>,<RTN_NO_SEQ>,<ORDER_CAT1_CODE>,<REGION_CODE>,<DEPT_CODE>, <CAT1_TYPE>, <VS_DR_CODE> &
			    //add by wanglong 20130624
			   ,<PARENT_CASE_NO>,<PARENT_ORDER_NO>,<PARENT_ORDER_SEQ>,<PARENT_START_DTTM>,<RT_KIND>,'Y' &
			   )
onInsertM.Debug=N

onInsertMRtn.Type=TSQL
onInsertMRtn.SQL=INSERT INTO ODI_DSPNM (CASE_NO,   ORDER_NO,  ORDER_SEQ, START_DTTM, END_DTTM,ORDER_CODE,  ORDER_DESC, DC_TOT,   RTN_DOSAGE_QTY,  RTN_DOSAGE_UNIT,  TRANSMIT_RSN_CODE,  DSPN_USER, DSPN_DATE,OPT_DATE,OPT_USER,  OPT_TERM,DSPN_KIND,EXEC_DEPT_CODE,       MR_NO,STATION_CODE,   BED_NO,  IPD_NO,DISPENSE_QTY,DISPENSE_UNIT,      DOSE_TYPE,GIVEBOX_FLG,     OWN_PRICE,PHA_TYPE,ROUTE_CODE,RTN_NO,RTN_NO_SEQ,ORDER_CAT1_CODE,REGION_CODE,DEPT_CODE, CAT1_TYPE, VS_DR_CODE,BATCH_SEQ1,VERIFYIN_PRICE1,DISPENSE_QTY1,CANCEL_DOSAGE_QTY) &
                           VALUES(  <CASE_NO>,<ORDER_NO>,<ORDER_SEQ>,<START_DTTM>,<END_DTTM>,<ORDER_CODE>,<ORDER_DESC>,<DC_TOT>,<RTN_DOSAGE_QTY>,<RTN_DOSAGE_UNIT>,<TRANSMIT_RSN_CODE>,<DSPN_USER>,SYSDATE,  SYSDATE,<OPT_USER>,<OPT_TERM>,<RX_KIND>,<EXEC_DEPT_CODE>,<MR_NO>,<STATION_CODE>,<BED_NO>,<IPD_NO>,<DISPENSE_QTY>,<DISPENSE_UNIT>,<DOSE_TYPE>,<GIVEBOX_FLG>,<OWN_PRICE>,<PHA_TYPE>,<ROUTE_CODE>,<RTN_NO>,<RTN_NO_SEQ>,<ORDER_CAT1_CODE>,<REGION_CODE>,<DEPT_CODE>, <CAT1_TYPE>, <VS_DR_CODE>,<BATCH_SEQ1>,<VERIFYIN_PRICE1>,<DISPENSE_QTY1>,<CANCEL_DOSAGE_QTY>)
onInsertMRtn.Debug=N
//luhai 2012-04-13 退药时暂时不处理seq  end

onUpdateM.Type=TSQL
onUpdateM.SQL=UPDATE ODI_DSPNM SET DC_TOT=<DC_TOT>,RTN_DOSAGE_QTY=<RTN_DOSAGE_QTY>,DISPENSE_QTY1=<RTN_DOSAGE_QTY>,TRANSMIT_RSN_CODE=<TRANSMIT_RSN_CODE>,OPT_TERM=<OPT_TERM> ,OPT_USER=<OPT_USER>,OPT_DATE=SYSDATE WHERE CASE_NO=<CASE_NO> AND ORDER_NO=<ORDER_NO> AND ORDER_CODE=<ORDER_CODE> AND ORDER_SEQ=<ORDER_SEQ> AND START_DTTM=<START_DTTM> AND DSPN_KIND='RT'  
onUpdateM.Debug=N
