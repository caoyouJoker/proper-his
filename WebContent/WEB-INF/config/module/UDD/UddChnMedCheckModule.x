Module.item=onUpdateOCheck;onUpdateMCheck;onUpdateMDosage;onUpdateMDispense;onUpdateMedODosage;onUpdateMedMDosage;onUpdateMedMDispense;&
	onUpdateMedDDispense;onUpdateMedDDosage;onUpdateUnChargeMedMDosage;onUpdateUnChargeMedMDispense;onUpdateUnChargeMedDDosage;&
	onUpdateUnChargeMedDDispense;onUpdateCnclMedDDosage;onUpdateUnChargeCnclMedDDosage;onUpdateCnclMedMDosage;&
	onUpdateUnChargeCnclMedMDosage;onUpdateOUnCheck;onUpdateMUnCheck;onUpdateUnChargeCnclMedDDispense;&
	onUpdateUnChargeCnclMedMDispense;onUpdateMedDispenseDetail;updateUddDBarCode;updateUddMBarCode;&
	insertOdiDspnd;insertOdiDspnM;updateOdiOrder;onUpdateIvaDMes;onUpdateIvaMMes;updatePhaAnti;onUpdateIvaDSTFMes;onCancelIvaDSTFMes
...
//wanglong modify 20141030 WHRERE增加ORDER_SEQ条件，否则会更新别的医嘱的信息
onUpdateMCheck.SQL=UPDATE ODI_DSPNM SET PHA_CHECK_CODE=<OPT_USER>,PHA_CHECK_DATE=SYSDATE,OPT_USER=<OPT_USER>,OPT_DATE=SYSDATE,OPT_TERM=<OPT_TERM>,DCTAGENT_FLG=<DCTAGENT_FLG> WHERE CASE_NO=<CASE_NO> AND ORDER_NO=<ORDER_NO> AND ORDER_SEQ=<ORDER_SEQ>
...
onUpdateMUnCheck.SQL=UPDATE ODI_DSPNM SET PHA_CHECK_CODE='',PHA_CHECK_DATE=NULL,OPT_USER=<OPT_USER>,OPT_DATE=SYSDATE,OPT_TERM=<OPT_TERM>,IVA_FLG='N',PN_FLG='N' WHERE CASE_NO=<CASE_NO> AND ORDER_NO=<ORDER_NO> AND ORDER_SEQ=<ORDER_SEQ>
...
insertOdiDspnd.SQL=INSERT INTO ODI_DSPND ( &
		...
		EXEC_DEPT_CODE,OPT_USER,OPT_DATE,OPT_TERM,INTGMED_NO,BATCH_CODE,IVA_FLG &
		...
		<OPT_USER>,<OPT_DATE>,<OPT_TERM>,<INTGMED_NO>,<BATCH_CODE>,<IVA_FLG> &
...
insertOdiDspnM.SQL=INSERT INTO ODI_DSPNM (&
		...
		OPT_USER,OPT_DATE,OPT_TERM,INTGMED_NO,IVA_FLG &
...
//临时，首日量更新ODI_DSPND:IVA_FLG,BATCH_CODE
...
//长期摆药更新ODI_DSPND:IVA_FLG,BATCH_CODE
...
//回写ODI_ORDER的字段==pangben 2015-10-28 序号去掉，更新一个期号的药品
updatePhaAnti.Type=TSQL
updatePhaAnti.SQL= UPDATE PHA_ANTI SET BATCH_NO=<BATCH_NO> WHERE CASE_NO=<CASE_NO> AND ORDER_CODE=<ORDER_CODE> AND PHA_SEQ=<PHA_SEQ> 
