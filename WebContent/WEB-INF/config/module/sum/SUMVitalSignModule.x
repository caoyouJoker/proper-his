Module.item=checkIsExist;selectExmUser;selectOneDayDtl;selectOneDayMst;selectVitalSignDtl;selectVitalSign;insertVitalSign;insertVitalSignDtl;updateVitalSign;updateVitalSignDtl;updateHWForAdminp
...
// 新增 A.SPECIALRESPIRENOTE字段
selectVitalSignDtl.SQL=SELECT  A.SPECIALRESPIRENOTE,  A.EXAMINE_DATE||A.EXAMINESESSION AS EXAMINEFLG , A.TEMPERATURE , A.PLUSE , A.RESPIRE , A.NOTPRREASONCODE , A.PHYSIATRICS ,&
...
selectVitalSign.SQL=  SELECT  A.SPECIALSTOOLNOTE, A.EXAMINE_DATE ,A.OPE_DAYS ,A.OUTPUTURINEQTY ,A.STOOL ,A.INTAKEFLUIDQTY ,A.HEIGHT ,A.WEIGHT, &

                               B.CHN_DESC USER_DEFINE_1,USER_DEFINE_1_VALUE, &
                               
                               C.CHN_DESC USER_DEFINE_2,USER_DEFINE_2_VALUE, &
                               
                               D.CHN_DESC USER_DEFINE_3,USER_DEFINE_3_VALUE, &
                               
                               A.DRAINAGE,A.ENEMA,A.AUTO_STOOL &
...
insertVitalSign.SQL=INSERT INTO SUM_VITALSIGN ( &
		...
		SPECIALSTOOLNOTE,ADM_TYPE,CASE_NO,EXAMINE_DATE,IPD_NO, &
		...
		AUTO_STOOL,ENEMA,DRAINAGE) &
		
		VALUES (<SPECIALSTOOLNOTE>,<ADM_TYPE>,<CASE_NO>,<EXAMINE_DATE>,<IPD_NO>, &
...
//add SPECIALRESPIRENOTE
		...
		//add SPECIALRESPIRENOTE
		VALUES (<SPECIALRESPIRENOTE>,<ADM_TYPE>,<CASE_NO>,<EXAMINE_DATE>,<EXAMINESESSION>,<PHYSIATRICS>, &
...
// 增加SPECIALSTOOLNOTE
		HEIGHT=<HEIGHT>,WEIGHT=<WEIGHT>,SPECIALSTOOLNOTE=<SPECIALSTOOLNOTE>, &
		...
		USER_DEFINE_3=<USER_DEFINE_3>,USER_DEFINE_3_VALUE=<USER_DEFINE_3_VALUE>,OPT_USER=<OPT_USER>,OPT_DATE=<OPT_DATE>,OPT_TERM=<OPT_TERM>,AUTO_STOOL = <AUTO_STOOL>,ENEMA = <ENEMA>,OPE_DAYS = <OPE_DAYS>,DRAINAGE = <DRAINAGE> &
