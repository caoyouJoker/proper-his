Module.item=selectNewArrivalSignDtl;selectNewArrivalSign;selectNewArrExmUser;selectOneDayDtl;selectOneDayMst;insertNewArrival;insertNewArrivalDtl;checkIsExist;updateNewArrival;updateNewArrivalDtl;getNewAdmWeight;getNewBornWeight
...
selectNewArrivalSign.SQL=SELECT   A.EXAMINE_DATE, A.BORNWEIGHT, A.URINETIMES, A.DRAINTIMES, C.QUALITY_DESC AS DRAINQUALITY, &
...
insertNewArrival.SQL=INSERT INTO SUM_NEWARRIVALSIGN  (ADM_TYPE,CASE_NO,EXAMINE_DATE,IPD_NO,MR_NO, &
		...
		ELES,OPT_USER,OPT_DATE,OPT_TERM ) &
...
updateNewArrival.SQL=UPDATE SUM_NEWARRIVALSIGN  SET &
		...
		ELES=<ELES>,OPT_USER=<OPT_USER>,OPT_DATE=<OPT_DATE>,OPT_TERM=<OPT_TERM>  &
