...
Module.item=insert;query;queryPackByBatch


//新建出库主档
insert.Type=TSQL
insert.SQL=INSERT INTO INV_SUP_DISPENSEM( &
			DISPENSE_NO , PACK_MODE , REQUEST_TYPE, REQUEST_NO  ,DISPENSE_DATE, &
			FROM_ORG_CODE , TO_ORG_CODE ,  DISPENSE_USER , URGENT_FLG, REQUEST_DATE, &
			REMARK , DISPOSAL_FLG , CHECK_DATE , CHECK_USER , REN_CODE, FINA_FLG, &
			OPT_USER , OPT_DATE , OPT_TERM, MATERIAL_LOCATION, IN_ORG_CODE) &
	    	      VALUES( &
	    	   	<DISPENSE_NO> ,  <PACK_MODE> , <REQUEST_TYPE> , <REQUEST_NO> , <DISPENSE_DATE>, &
	    	   	<FROM_ORG_CODE> ,  <TO_ORG_CODE> , <DISPENSE_USER> , <URGENT_FLG>, <REQUEST_DATE>, &
	    	   	<REMARK> ,  <DISPOSAL_FLG> , <CHECK_DATE> , <CHECK_USER> , <REN_CODE>, <FINA_FLG>, &
	    	   	<OPT_USER> , SYSDATE , <OPT_TERM>, <MATERIAL_LOCATION>, <IN_ORG_CODE> )
insert.Debug=N
...
query.SQL=SELECT A.DISPENSE_NO, A.TO_ORG_CODE, A.FROM_ORG_CODE, A.REQUEST_TYPE, &
                 A.CHECK_DATE, A.CHECK_USER, A.REQUEST_NO, A.PACK_MODE, B.SUPTYPE_CODE, A.REN_CODE,A.URGENT_FLG, A.FINA_FLG,A.REMARK, A.MATERIAL_LOCATION, IN_ORG_CODE &
...
//查询某种诊疗包的全部批次
queryPackByBatch.Type=TSQL
queryPackByBatch.SQL=SELECT M.ORG_CODE, M.PACK_CODE, M.PACK_SEQ_NO, M.BARCODE, M.PACK_BATCH_NO, M.QTY FROM INV_PACKSTOCKM M & 
			WHERE M.ORG_CODE = <ORG_CODE> AND M.PACK_CODE = <PACK_CODE> AND QTY > 0 ORDER BY PACK_BATCH_NO ASC
queryPackByBatch.Debug=N
