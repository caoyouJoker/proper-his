...
insertConfirmApply.SQL=INSERT INTO INS_ADM_CONFIRM(&
			   ...
			   OVERINP_FLG, INSCASE_NO, OPEN_FLG, &
			   SOURCE_CODE, CANCEL_FLG, CONFIRM_SRC, &
			   OPT_USER, OPT_DATE, OPT_TERM, OPEN_DATE, &
			   IN_STATUS,CASE_NO,IN_HOSP_NO,UP_DATE,HIS_CTZ_CODE,SPECIAL_PAT, &
                           INS_CROWD_TYPE,LOCAL_FLG,OUTP_CARRYOVER_AMT &
			   )&
			   ...
			   <OVERINP_FLG>, <INSCASE_NO>, <OPEN_FLG>, &
			   <SOURCE_CODE>, <CANCEL_FLG>, <CONFIRM_SRC>, &
			   <OPT_USER>, SYSDATE, <OPT_TERM>, SYSDATE, &
			   <IN_STATUS>,<CASE_NO>,<IN_HOSP_NO>,<UP_DATE>,<HIS_CTZ_CODE>,<SPECIAL_PAT>,<INS_CROWD_TYPE>,<LOCAL_FLG>,<OUTP_CARRYOVER_AMT>)
...
updateConfirmApply.SQL=UPDATE INS_ADM_CONFIRM SET &
		       ...
		       PAT_CLASS=<PAT_CLASS>,ZFBL2=<ZFBL2>,IN_HOSP_NO=<IN_HOSP_NO>, &
                       INS_CROWD_TYPE=<INS_CROWD_TYPE>,LOCAL_FLG=<LOCAL_FLG>,OUTP_CARRYOVER_AMT=<OUTP_CARRYOVER_AMT> WHERE CONFIRM_NO=<CONFIRM_NO>
...
insertDownLoadAdmConfirm.SQL=INSERT INTO INS_ADM_CONFIRM (&
		       ...
		       IN_HOSP_NO,HOSP_CLASS_CODE,ADM_CATEGORY,EMG_FLG,TRAN_CLASS,OVERINP_FLG,OPEN_FLG,CONFIRM_SRC,IN_STATUS,UP_DATE,&
                       CANCEL_FLG,HIS_CTZ_CODE,SPECIAL_PAT,INS_CROWD_TYPE,LOCAL_FLG,OUTP_CARRYOVER_AMT) &
		       ...
		       <OVERINP_FLG>,<OPEN_FLG>,<CONFIRM_SRC>,<IN_STATUS>,<UP_DATE>,<CANCEL_FLG>,<HIS_CTZ_CODE>,&
                       <SPECIAL_PAT>,<INS_CROWD_TYPE>,<LOCAL_FLG>,<OUTP_CARRYOVER_AMT>)
