Module.item=query;update;insert;delete;query_sys_ins;importOrder;onQueryMaxSxka004

//查询三目ins_ka_004基本档数据
query.Type=TSQL
query.SQL=SELECT AKA100, AKA101, AKA102, AKA063, AKA065, BKA246, BKA247, BKA260, BKA001, AKA103, AKA066, AKA068, AKA069, AAE011, TO_CHAR(AAE036, 'YYYY-mm-dd hh24:MI:SS')AAE036, BAA001, AKA104, AAE100, HOSP_ORDER_CODE, FEE_TYPE, LIMIT_PRICE FROM ORAL.INS_SX_KA004 ORDER BY AKA100
...
/删除数据
delete.Type=TSQL
delete.SQL=DELETE FROM INS_SX_KA004 WHERE AKA100=<AKA100>
delete.Debug=N

//新增
insert.Type=TSQL
insert.SQL=INSERT INTO INS_SX_KA004&
...
importOrder.SQL=INSERT INTO INS_SX_KA004 &
...
onQueryMaxSxka004.Type=TSQL
onQueryMaxSxka004.SQL=SELECT AKA100, AKA101, AKA102, AKA063, AKA065, &
			...
			WHERE AAE036=(SELECT MAX(AAE036) FROM INS_SX_KA004  ) &
			
			ORDER BY AKA100
onQueryMaxSxka004.Debug=N