Module.item=query;update;insert;delete;query_sys_ins;importOrder;onQueryMaxXaka003

//查询三目ins_ka_002基本档数据
query.Type=TSQL
query.SQL=SELECT NHI_ORDER_CODE, HOSP_CLASS, NHI_ORDER_DESC, CHARGE_CODE, AKA065, ORDER_CAT1, ORDER_CAT2, ORDER_CAT3, DESCRIPTION, MEMO, PRICE, OWN_RATE, NHI_BASE_PRICE, APPROVE_USER_ID, TO_CHAR(APPROVE_DATE, 'YYYY-mm-dd hh24:MI:SS')APPROVE_DATE, DATAAREA_NO, ACTIVE_FLG, HOSP_ORDER_CODE, FEE_TYPE, LIMIT_PRICE FROM ORAL.INS_XA_KA003 ORDER BY NHI_ORDER_CODE
...
//删除数据
delete.Type=TSQL
delete.SQL=DELETE FROM INS_XA_KA003 WHERE NHI_ORDER_CODE=<NHI_ORDER_CODE>
delete.Debug=N

//新增
insert.Type=TSQL
insert.SQL=INSERT INTO INS_XA_KA003 &
...
importOrder.SQL=INSERT INTO INS_XA_KA003 &
...
onQueryMaxXaka003.Type=TSQL
onQueryMaxXaka003.SQL=SELECT NHI_ORDER_CODE, HOSP_CLASS, NHI_ORDER_DESC, CHARGE_CODE, AKA065,&
		...
		DATAAREA_NO, ACTIVE_FLG, HOSP_ORDER_CODE, FEE_TYPE, LIMIT_PRICE &
			...
			WHERE APPROVE_DATE=(SELECT MAX(APPROVE_DATE) FROM INS_XA_KA003  ) &
			
			ORDER BY NHI_ORDER_CODE
onQueryMaxXaka003.Debug=N