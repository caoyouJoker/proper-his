...
selectSpcMemo.SQL=SELECT SPC_MEMO,CASE_NO  FROM INS_MZ_CONFIRM WHERE CASE_NO=<CASE_NO> AND SPC_MEMO IS NOT NULL
...
updateInsMZConfirmSpcMemo.SQL=UPDATE INS_MZ_CONFIRM SET SPC_MEMO=<SPC_MEMO>,OPT_USER=<OPT_USER>,OPT_DATE=SYSDATE,OPT_TERM=<OPT_TERM> WHERE CASE_NO=<CASE_NO>
...
queryMZConfirm.SQL=SELECT A.REGION_CODE, A.CASE_NO, A.MR_NO,&
		   A.CONFIRM_NO AS CONFIRM_NO, A.INSCARD_NO, A.INSCARD_PASSWORD,& 
