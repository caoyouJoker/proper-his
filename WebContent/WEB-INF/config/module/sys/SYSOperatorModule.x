Module.item=existsOperator;getOperatorName;getOperatorPassword;setOperatorPassword;&
	...
	getCasherCode;getOperatorEngName;getOperatorPosCode;getOperatorObateDate;userInfoChange;updatePwdobateDate;getOperatorUkey;getCostCenterCode;getOperatorNurseInfo;emrRuleUser
...
//得到用户职别
getOperatorPosCode.Type=TSQL
getOperatorPosCode.SQL=SELECT POS_CODE FROM SYS_OPERATOR WHERE USER_ID=<USER_ID>
getOperatorPosCode.Debug=N 
...
//得到护工用户基本信息
getOperatorNurseInfo.Type=TSQL
getOperatorNurseInfo.SQL=SELECT * FROM SYS_OPERATOR_NURSE WHERE USER_ID=<USER_ID>
getOperatorNurseInfo.Debug=N

//保存用户角色配置表EMR_RULE_USER
emrRuleUser.Type=TSQL
emrRuleUser.SQL=INSERT INTO EMR_RULE_USER &
            (ID, EMR_RULE_CODE, USER_EMR_ID, START_DATE, END_EMR_DATE) &
     VALUES (<ID>, <EMR_RULE_CODE>, <USER_EMR_ID>, <START_DATE>, <END_EMR_DATE>)
emrRuleUser.Debug=N
