...
getQueryRegressgoods.SQL=SELECT A.REGRESSGOODS_NO, F.SUP_ABS_DESC, E.CHECK_DATE AS REGRESSGOODS_DATE, &
								...
								A.QTY,A.VERIFYIN_PRICE AS UNIT_PRICE,A.QTY*A.VERIFYIN_PRICE AS REG_AMT, &
								A.RETAIL_PRICE,A.QTY*A.RETAIL_PRICE AS OWN_AMT, &
								A.QTY*A.RETAIL_PRICE-A.QTY*A.VERIFYIN_PRICE AS DIFF_ATM, &
