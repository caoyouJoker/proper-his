...
Module.item=insertDDStock;qyeryDDStock;queryDDStcokDayA;queryDDStcokDayB;queryDDStcokDayStockOwn;queryDDStcokDayC;queryDDStcokDayD;getbildrugQuery;insertStockHistory
...
queryDDStcokDayStockOwn.SQL=SELECT SUM (STOCK_QTY * VERIFYIN_PRICE) AS STOCK_AMT, &
       			    SUM (STOCK_QTY*RETAIL_PRICE) AS OWN_AMT &
  			FROM IND_DDSTOCK &
 			WHERE TRANDATE =<END_DATE> &		
   			  AND ORG_CODE = <ORG_CODE> &
   			  AND ORDER_CODE = <ORDER_CODE>	  
