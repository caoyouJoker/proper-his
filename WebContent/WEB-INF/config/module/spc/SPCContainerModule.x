...
// add by wangbin 2015/1/26 内部需求 #793 病区管理 > 紧急抢救出智能柜 相关调整 START
queryJjMj.item=CABINET_ID
queryJjMj.CABINET_ID=A.CABINET_ID=<CABINET_ID>
// add by wangbin 2015/1/26 内部需求 #793 病区管理 > 紧急抢救出智能柜 相关调整 END
queryJjMj.Debug=N
