...
queryPurOrderM.SQL=SELECT PURORDER_DATE, PURORDER_NO, ORG_CODE, PLAN_NO, SUP_CODE, &
			  ...
			  OPT_TERM,DRUG_CATEGORY,CHECK_USER,CHECK_DATE,APPLY_TYPE &
		     FROM IND_PURORDERM ORDER BY PURORDER_NO
queryPurOrderM.ITEM=ORG_CODE;SUP_CODE;PURORDER_NO;START_DATE;END_DATE;REGION_CODE;APPLY_TYPE1;APPLY_TYPE2;APPLY_TYPE3;DRUG_CATEGORY;CHECK_DATE_START;CHECK_DATE_END
...
queryPurOrderM.CHECK_DATE_START=CHECK_DATE>=<CHECK_DATE_START>
queryPurOrderM.CHECK_DATE_END=CHECK_DATE<=<CHECK_DATE_END>
queryPurOrderM.APPLY_TYPE1=APPLY_TYPE<>'3' AND PLAN_NO IS  NULL
queryPurOrderM.APPLY_TYPE2=APPLY_TYPE<>'3' AND PLAN_NO IS NOT NULL
queryPurOrderM.APPLY_TYPE3=APPLY_TYPE='3'
queryPurOrderM.DRUG_CATEGORY=DRUG_CATEGORY=<DRUG_CATEGORY>
...
createPurOrderM.SQL=INSERT INTO IND_PURORDERM( &
			...
			REASON_CHN_DESC , DESCRIPTION , PLAN_NO, OPT_USER , OPT_DATE , OPT_TERM, REGION_CODE,DRUG_CATEGORY,APPLY_TYPE) &
	    	      VALUES( &
	    	   	<PURORDER_DATE> ,  <PURORDER_NO> , <ORG_CODE> , <SUP_CODE> , <RES_DELIVERY_DATE> , &
	    	   	<REASON_CHN_DESC> ,  <DESCRIPTION> , <PLAN_NO> , <OPT_USER> , <OPT_DATE> , <OPT_TERM> , <REGION_CODE>,<DRUG_CATEGORY>,<APPLY_TYPE>)
