...
RAPA_NUM;OPBFAF;Insert_Station_Daily;delete_Station_Daily;select_Station_Daily;updateREAL_OCUU_BED_NUM;CARE_NUMS;DS_ADM_NUM
...
RECOVER_NUM.SQL=SELECT COUNT(CASE_NO) AS O_NUM,OUT_STATION AS STATION_CODE,OUT_DEPT AS DEPT_CODE &
	        FROM MRO_RECORD &
...
//=============pangben modify 20110617 添加区域条件
RECOVER_NUM.REGION_CODE=REGION_CODE=<REGION_CODE>
RECOVER_NUM.Debug=N

//好转病人数
EFFECT_NUM.Type=TSQL
EFFECT_NUM.SQL=SELECT COUNT(CASE_NO) AS O_NUM,OUT_STATION AS STATION_CODE,OUT_DEPT AS DEPT_CODE &
	       FROM MRO_RECORD &
	       WHERE OUT_DATE BETWEEN TO_DATE(<STADATE>,'YYYYMMDD') AND TO_DATE(<STADATE>||' 23:59:59','YYYYMMDD HH24:MI:SS') &
	       AND CODE1_STATUS='2' &
	       GROUP BY OUT_DEPT,OUT_STATION
...
//=============pangben modify 20110617 添加区域条件
EFFECT_NUM.REGION_CODE=REGION_CODE=<REGION_CODE>
EFFECT_NUM.Debug=N

//未愈人数
INVALED_NUM.Type=TSQL
INVALED_NUM.SQL=SELECT COUNT(CASE_NO) AS O_NUM,OUT_STATION AS STATION_CODE,OUT_DEPT AS DEPT_CODE &
	        FROM MRO_RECORD &
	        WHERE OUT_DATE BETWEEN TO_DATE(<STADATE>,'YYYYMMDD') AND TO_DATE(<STADATE>||' 23:59:59','YYYYMMDD HH24:MI:SS') &
	        AND CODE1_STATUS='3' &
	        GROUP BY OUT_DEPT,OUT_STATION
...
//=============pangben modify 20110617 添加区域条件
INVALED_NUM.REGION_CODE=REGION_CODE=<REGION_CODE>
INVALED_NUM.Debug=N

//死亡人数 
DIED_NUM.Type=TSQL
DIED_NUM.SQL=SELECT COUNT(CASE_NO) AS O_NUM,OUT_STATION AS STATION_CODE,OUT_DEPT AS DEPT_CODE &
	     FROM MRO_RECORD &
	     WHERE OUT_DATE BETWEEN TO_DATE(<STADATE>,'YYYYMMDD') AND TO_DATE(<STADATE>||' 23:59:59','YYYYMMDD HH24:MI:SS') &
	     AND CODE1_STATUS='4' &
	     GROUP BY OUT_DEPT,OUT_STATION
...
//=============pangben modify 20110617 添加区域条件
DIED_NUM.REGION_CODE=REGION_CODE=<REGION_CODE>
DIED_NUM.Debug=N

//其他人数
OTHER_NUM.Type=TSQL
OTHER_NUM.SQL=SELECT COUNT(CASE_NO) AS O_NUM,OUT_STATION AS STATION_CODE,OUT_DEPT AS DEPT_CODE &
	      FROM MRO_RECORD &
	      WHERE OUT_DATE BETWEEN TO_DATE(<STADATE>,'YYYYMMDD') AND TO_DATE(<STADATE>||' 23:59:59','YYYYMMDD HH24:MI:SS') &
	      AND CODE1_STATUS='5' &
	      GROUP BY OUT_DEPT,OUT_STATION
...
//=============pangben modify 20110617 添加区域条件
OTHER_NUM.REGION_CODE=REGION_CODE=<REGION_CODE>
OTHER_NUM.Debug=N
...
//=============pangben modify 20110617 添加区域条件
//TRANS_DEPT_NUM.REGION_CODE=REGION_CODE=<REGION_CODE>		   
