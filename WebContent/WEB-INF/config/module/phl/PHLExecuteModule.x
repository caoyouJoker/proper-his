...
queryExecute.SQL=SELECT 'N' AS LFLG,  &   
			CASE WHEN A.EXEC_STATUS = '0' THEN 'N' ELSE 'Y' &
		        ...
		        E.USER_NAME AS DR_NAME, G.USER_NAME AS PHA_NAME, A.BAR_CODE,F.SKINTEST_FLG, &
		        A.BAR_CODE_PRINT_FLG, H.USER_NAME AS EXECUTE_NAME,&
...
queryExecuteForOnw.SQL=SELECT 'N' AS SELECTED,A.LINKMAIN_FLG,A.LINK_NO,A.MR_NO,F.PAT_NAME,A.ORDER_CODE,A.ORDER_DESC,A.MEDI_QTY,  &
		      ...
		      A.SKINTEST_FLG,A.NS_NOTE, D.DOSE_CHN_DESC,A.ORDER_DATE,A.DR_CODE,A.PHA_DISPENSE_DATE,A.PHA_DISPENSE_CODE,  &
		       A.NS_EXEC_CODE,A.NS_EXEC_DATE,A.CASE_NO,A.RX_NO,A.SEQ_NO,A.EXEC_DATE,A.ADM_TYPE,E.CLINICAREA_CODE,  &
...
queryExecuteForOnwYes.SQL=SELECT 'N' AS SELECTED,A.LINKMAIN_FLG,A.LINK_NO,A.MR_NO,F.PAT_NAME,A.ORDER_CODE,A.ORDER_DESC,A.MEDI_QTY,  &
                       A.MEDI_UNIT,A.DISPENSE_QTY,A.DISPENSE_UNIT,A.FREQ_CODE,A.ROUTE_CODE, &
		      A.SKINTEST_FLG,A.NS_NOTE, D.DOSE_CHN_DESC,A.ORDER_DATE,A.DR_CODE,A.PHA_DISPENSE_DATE,A.PHA_DISPENSE_CODE,  &
		       A.NS_EXEC_CODE,A.NS_EXEC_DATE,A.CASE_NO,A.RX_NO,A.SEQ_NO,TO_DATE (A.EXEC_DATE, 'YYYY/MM/DD HH24:MI:SS'),A.ADM_TYPE,E.CLINICAREA_CODE,  &
		       E.CLINICROOM_NO,A.DEPT_CODE &   
