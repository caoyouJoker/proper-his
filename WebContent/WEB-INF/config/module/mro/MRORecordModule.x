...
#
###############################
Module.item=selectCountOfInHosp;selectInHospInfo;selectChargeName;updateFourPage;updateFirstPage;updateSecendPage;insertPatInfo;updateOutDept;&
	    ...
	    deleteMRO;updateCONFIRM_DATE;updateForWaitPat;existMDiagCode;updateSCODE;updateTYPERESULT;getNewBornFlg;getMroChargeName;insertMRODiag;updateMRODiag;updatenewMRODiag;updateMRODiagSeq
...
selectInHospInfo.SQL=SELECT CASE_NO, MR_NO, IPD_NO, PAT_NAME, SEX, &
			...
			// add by wangqing 20180116 新增呼吸机使用分钟、呼吸机使用秒VENTI_TIME_MIN、VENTI_TIME_SEC
			BANKED_BLOOD,NB_AGE,NB_WEIGHT2,NB_WEIGHT3,NB_WEIGHT4,NB_WEIGHT5,DAY_OPE_FLG, VENTI_TIME_MIN, VENTI_TIME_SEC &
			//==========add by huangtt 20161222 DAY_OPE_FLG
...
updateSecendPage.SQL=UPDATE MRO_RECORD SET TRANS_DEPT=<TRANS_DEPT> ,&
			...
			//add by huangtt 20161222 DAY_OPE_FLG  日间手术
			DAY_OPE_FLG=<DAY_OPE_FLG>, &			
			BANKED_BLOOD=<BANKED_BLOOD> &
			// add by wangqing 20180116 start 新增呼吸机使用分钟、呼吸机使用秒
			,VENTI_TIME_MIN = <VENTI_TIME_MIN> &
			,VENTI_TIME_SEC = <VENTI_TIME_SEC> &
...
insertOP.SQL=INSERT INTO MRO_RECORD_OP ( &
					...
					OPT_USER,OPT_DATE,OPT_TERM,MAIN_FLG,AGN_FLG, &
					OPE_SITE,OPE_TIME,ANA_LEVEL,NNIS_CODE &
				) VALUES ( &
					<CASE_NO>,<SEQ_NO>,<IPD_NO>,<MR_NO>,<OP_CODE>, &
					<OP_DESC>,<OP_REMARK>,TO_DATE(<OP_DATE>,'YYYYMMDD HH24MISS'),<ANA_WAY>,<ANA_DR>, &
					<MAIN_SUGEON>,<MAIN_SUGEON_REMARK>,<AST_DR1>,<AST_DR2>,<HEALTH_LEVEL>,<OP_LEVEL>, &
					<OPT_USER>,<OPT_DATE>,<OPT_TERM>,<MAIN_FLG>,<AGN_FLG>,<OPE_SITE>,<OPE_TIME>,<ANA_LEVEL>,<NNIS_CODE>  )
insertOP.Debug=N
...
creatMRO.SQL=INSERT INTO MRO_RECORD &
		    (CASE_NO, MR_NO, OPT_USER, OPT_TERM, OPT_DATE,REGION_CODE,HOSP_ID, DAY_OPE_FLG&
		    ) &
	     VALUES (<CASE_NO>, <MR_NO>, <OPT_USER>, <OPT_TERM>, SYSDATE,<REGION_CODE>,<HOSP_ID>,<DAY_OPE_FLG> &
		    )
creatMRO.Debug=N
...
queryOP_Info.SQL=SELECT &
		   ...
		   OPT_USER, OPT_DATE, OPT_TERM, MAIN_FLG,AGN_FLG,OPE_SITE,OPE_TIME,ANA_LEVEL &
		FROM MRO_RECORD_OP &
		ORDER BY SEQ_NO
...
updateMRODiag.Type=TSQL
updateMRODiag.SQL=UPDATE MRO_RECORD_DIAG &
			SET IPD_NO = <IPD_NO>,&
			IO_TYPE = <IO_TYPE>,&
			ICD_KIND = <ICD_KIND>,&
			MAIN_FLG = <MAIN_FLG>,&
...
//修改病案诊断信息(MRO_RECORD_DIAG中诊断信息老数据有变动需要修改｛增加变动SEQ_NO ｝  wukai add 20170407)
updateMRODiagSeq.Type=TSQL
updateMRODiagSeq.SQL=UPDATE MRO_RECORD_DIAG &
			SET IPD_NO = <IPD_NO>,&
			IO_TYPE = <IO_TYPE>,&
			ICD_KIND = <ICD_KIND>,&
			MAIN_FLG = <MAIN_FLG>,&
			...
			SEQ_NO = <SEQ_NO> &
			WHERE CASE_NO = <CASE_NO> & 
			        AND ICD_CODE = <OLD_ICD_CODE> &
                                AND IO_TYPE = <OLD_IO_TYPE> 
updateMRODiagSeq.Debug=N