...
insertdata.SQL=INSERT INTO REG_SCHDAY &
			   ...
			   OPT_TERM,REG_CLINICAREA,REG_SPECIAL_NUMBER) &
...
updatedata.SQL=UPDATE REG_SCHDAY &
		  SET REGION_CODE=<REGION_CODE>,ADM_TYPE=<ADM_TYPE>,ADM_DATE=<ADM_DATE>,&
		      ...
		      OPT_USER=<OPT_USER>,OPT_DATE=SYSDATE,OPT_TERM=<OPT_TERM>,REG_SPECIAL_NUMBER=<REG_SPECIAL_NUMBER> &
...
onQueryDrTable.SQL= SELECT   CASE &
 ...
 WHERE DR_CODE = REG_SCHDAY.DR_CODE &
   ...
   ,ADM_TYPE,ADM_DATE,SESSION_CODE,REG_SPECIAL_NUMBER &
    FROM REG_SCHDAY &
   WHERE stop_session = 'N' &
ORDER BY vip_flg
//====caowl 20120809 end

onQueryDrTable.item=REGION_CODE;ADM_TYPE;ADM_DATE;SESSION_CODE;DEPT_CODE_SORT;EXPERT;SORT;VIP_FLG
