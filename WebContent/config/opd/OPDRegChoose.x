...
TABLE.AutoWidth=Y
TABLE.AutoHeight=Y
TABLE.Header=病案号,100;就诊序号,100;挂号日期,100,timestamp,yyyy/MM/dd;姓名,80;就诊状态,100,ADM_STATUS;报告状态,100,REPORT_STATUS
