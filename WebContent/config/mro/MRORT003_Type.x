...
<Type=TFrame>
UI.Title=医生问题类型统计
UI.MenuConfig=%ROOT%\config\mro\MRORT003_TypeMenu.x
UI.Width=1024
UI.Height=748
UI.toolbar=Y
UI.controlclassname=com.javahis.ui.mro.MRORT003TypeControl
...
Table.AutoWidth=Y
Table.AutoHeight=Y
Table.Header=区域,120,REGION_CODE;科室,100,DEPT_CODE;病区,120,STATION_CODE;医师,100,VS_CODE;项目,280,TYPE_CODE;欠缺内容,360,EXAMINE_CODE;数量,60
Table.ColumnHorizontalAlignmentData=1,left;2,left;3,left;4,left;5,left;6,right
Table.ParmMap=REGION_CODE;DEPT_CODE;STATION_CODE;DR_CODE;TYPE_CODE;EXAMINE_CODE;EXAMINE_COUNT
Table.Item=REGION_CODE;DEPT_CODE;STATION_CODE;VS_CODE;TYPE_CODE;EXAMINE_CODE
...
tPanel_0.Item=OUT;IN;tLabel_0;tLabel_1;tLabel_2;tLabel_3;DATE_S;DATE_E;DEPT;VS_CODE;tLabel_5;STATION;tLabel_6;REGION_CODE
...
STATION.Height=22
STATION.Text=
STATION.HorizontalAlignment=2
STATION.PopupMenuHeader=代码,100;名称,100
STATION.PopupMenuWidth=300
STATION.PopupMenuHeight=300
STATION.PopupMenuFilter=ID,1;NAME,1;PY1,1
STATION.FormatType=combo
STATION.ShowDownButton=Y
STATION.Tip=病区
STATION.ShowColumnList=NAME
STATION.HisOneNullRow=Y
STATION.DeptCode=<DEPT>
...
VS_CODE.Height=22
VS_CODE.Text=
VS_CODE.HorizontalAlignment=2
VS_CODE.PopupMenuHeader=ID,100;NAME,100
VS_CODE.PopupMenuWidth=300
VS_CODE.PopupMenuHeight=300
VS_CODE.PopupMenuFilter=ID,1;NAME,1;PY1,1
VS_CODE.FormatType=combo
VS_CODE.ShowDownButton=Y
VS_CODE.Tip=人员
VS_CODE.ShowColumnList=NAME
VS_CODE.HisOneNullRow=Y
VS_CODE.PosType=1
VS_CODE.Dept=<DEPT>
DEPT.Type=科室
DEPT.X=371
...
TYPE_CODE.ModuleParmString=
TYPE_CODE.ModuleParmTag=
TYPE_CODE.Action=
TYPE_CODE.ExpandWidth=50
EXAMINE_CODE.Type=病案审核标准
EXAMINE_CODE.X=372
EXAMINE_CODE.Y=57
EXAMINE_CODE.Width=160
EXAMINE_CODE.Height=23
EXAMINE_CODE.Text=TButton
EXAMINE_CODE.showID=Y
EXAMINE_CODE.showName=Y
EXAMINE_CODE.showText=N
EXAMINE_CODE.showValue=N
EXAMINE_CODE.showPy1=Y
EXAMINE_CODE.showPy2=Y
EXAMINE_CODE.Editable=Y
EXAMINE_CODE.Tip=病案审核标准
EXAMINE_CODE.TableShowList=name
EXAMINE_CODE.ModuleParmString=
EXAMINE_CODE.ModuleParmTag=
EXAMINE_CODE.Action=
EXAMINE_CODE.ExpandWidth=150