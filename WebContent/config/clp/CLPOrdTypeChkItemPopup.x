...
TABLE.SpacingRow=1
TABLE.RowHeight=20
TABLE.Header=临床路径项目代码,120;临床路径项目名称,150;查核类别,100,CHKTYPE_CODE;项目代码,100;区域代码,100;中文说明,200;英文说明,200;项目拼音,100;助记码,100;顺序号,45;适用临床路径项目,100,CLNCPATH_CODE;被查核人员,100,CHKUSER_CODE;单独查核,60,Boolean;备注,200
TABLE.LockColumns=all
TABLE.ColumnHorizontalAlignmentData=0,left;1,left;2,left;3,left;4,left;5,left;6,left;7,left;8,left;9,right;10,left;11,left;12,left;13,left
TABLE.ParmMap=ORDTYPE_CODE;TYPE_CHN_DESC;CHKTYPE_CODE;ORDER_CODE;REGION_CODE;ORDER_CHN_DESC;ORDER_ENG_DESC;PY1;PY2;SEQ;CLNCPATH_CODE;CHKUSER_CODE;INDV_FLG;DESCRIPTION
TABLE.AutoX=Y
TABLE.AutoWidth=Y
TABLE.AutoHeight=Y
