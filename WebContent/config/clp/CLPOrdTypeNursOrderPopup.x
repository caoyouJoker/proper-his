...
UI.Height=300
UI.toolbar=N
UI.controlclassname=com.javahis.ui.clp.CLPOrdTypePopupControl
UI.item=tPanel_5
UI.layout=null
UI.FocusList=EDIT
UI.X=5
...
TABLE.SpacingRow=1
TABLE.RowHeight=20
TABLE.Header=临床路径项目代码,120;临床路径项目名称,150;护嘱代码,100;区域代码,100;护嘱名称,200;英文名称,200;护嘱简拼,100;助记码,100;单位,100,UNIT_CODE;频次,100;用量,30;护嘱类别代码,100;备注,200;删除注记,60,Boolean;查核类别,100,CHKTYPE_CODE;顺序号,45
TABLE.LockColumns=all
TABLE.ColumnHorizontalAlignmentData=0,left;1,left;2,left;3,left;4,left;5,left;6,left;7,left;8,left;9,left;10,right;11,left;12,left;13,left;14,left,15,right
TABLE.ParmMap=ORDTYPE_CODE;TYPE_CHN_DESC;ORDER_CODE;REGION_CODE;ORDER_CHN_DESC;ORDER_ENG_DESC;PY1;PY2;UNIT;FREQ;AMOUNT;TYPE_CODE;DESCRIPTION;DEL_FLG;CHKTYPE_CODE;SEQ
TABLE.AutoX=Y
TABLE.AutoWidth=Y
TABLE.AutoHeight=Y
TABLE.Item=UNIT_CODE;CHKTYPE_CODE
TABLE.SQL=
TABLE.LocalTableName=CLP_ORDTYPE
