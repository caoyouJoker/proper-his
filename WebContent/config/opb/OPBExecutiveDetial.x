...
##############################################
<Type=TFrame>
UI.Title=执行科室工作量统计明细项
UI.MenuConfig=
UI.Width=800
UI.Height=500
UI.toolbar=Y
UI.controlclassname=com.javahis.ui.opb.OPBExecutiveDetialControl
...
TABLE.AutoWidth=Y
TABLE.AutoHeight=Y
TABLE.Header=科别,80,DEPT_CODE;医生,70,DR_CODE;时段,70,SESSION_CODE;诊号,70;病案号,70;姓名,60;身份,60,CTZ1_CODE;医嘱名称,150;单价,40;数量,40;小计,40
