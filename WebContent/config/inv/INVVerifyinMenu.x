...
<Type=TMenuBar>
UI.Item=File;Window
UI.button=save;|;updateData;|;delete;|;query;|;clear;|;export;|;printNo;|;print;|;printBarcode;|;printBarcodeAll;|;close
...
File.Text=文件
File.M=F
File.Item=save;|;updateData;|;delete;|;query;|;clear;|;export;|;printNo;|;print;|;printBarcode;|;printBarcodeAll;|;close
...
printBarcodeAll.Text=条码打印(批量)
printBarcodeAll.Tip=条码打印(批量)
printBarcodeAll.M=A
