...
UI.item=TABLE1;FETCH;CANCEL;TABLE2;LBL_RX;RX_NO
UI.layout=null
UI.X=600
UI.Y=600
UI.zhTitle=调用常用医嘱
...
TABLE2.SpacingRow=1
TABLE2.RowHeight=20
TABLE2.Header=选,30,boolean;医嘱,250
TABLE2.AutoHeight=Y
TABLE2.ParmMap=CHOOSE;ORDER_DESC
TABLE2.ColumnHorizontalAlignmentData=1,left
TABLE2.LockColumns=1
...
TABLE1.AutoWidth=N
TABLE1.AutoHeight=Y
TABLE1.Header=选,30,boolean;医嘱,250
TABLE1.ColumnHorizontalAlignmentData=1,left
TABLE1.ParmMap=CHOOSE;ORDER_DESC
TABLE1.LockColumns=1
