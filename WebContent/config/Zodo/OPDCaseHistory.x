...
UI.Height=780
UI.toolbar=Y
UI.controlclassname=com.javahis.ui.opd.OpdCaseHistoryControl
UI.item=tPanel_0
UI.layout=null
UI.zhTitle=就诊记录
UI.enTitle=Clinical History
...
tPanel_0.Border=组
tPanel_0.Item=tPanel_1;tPanel_2;tMovePane_0
tMovePane_0.Type=TMovePane
tMovePane_0.X=234
tMovePane_0.Y=10
tMovePane_0.Width=12
tMovePane_0.Height=749
tMovePane_0.Text=
...
tPanel_2.Width=1009
tPanel_2.Height=756
tPanel_2.Border=组|医嘱详细|Detailed Order
tPanel_2.AutoHeight=Y
tPanel_2.AutoWidth=Y
tPanel_2.Item=SUBJ_TEXT;OBJ_TEXT;PHYSEXAM_REC;DIAG_TABLE;TTABBEDPANE;ZS;KS;TZ;DIAG;ORDER
ORDER.Type=TCheckBox
ORDER.X=10
ORDER.Y=270
ORDER.Width=93
ORDER.Height=23
...
INS_PAY.showID=Y
INS_PAY.Editable=Y
INS_PAY.StringData=[[id,name,enname],[A,医保,Health Insurance],[B,增付,Pay increase],[C,自费,Own expense]]
INS_PAY.ShowName=Y
INS_PAY.ShowText=N
...
TTABBEDPANE.X=10
TTABBEDPANE.Y=301
TTABBEDPANE.Width=988
TTABBEDPANE.Height=444
...
tPanel_7.zhTitle=管制药品
tPanel_7.enTitle=Controlled Narcotic
CTRL_TABLE.Type=TTable
CTRL_TABLE.X=7
CTRL_TABLE.Y=5
CTRL_TABLE.Width=971
CTRL_TABLE.Height=405
...
CTRL_TABLE.Header=连,30,boolean;组,40;医嘱,200;用量,60,double,##0.00;单位,40,UNIT_CODE;频次,50,FREQ_CODE;用法,80,ROUTE_CODE;日份,50,int,#0;总量,60,double;备,60,boolean;盒,30,boolean;单位,60,UNIT_CODE;执行科室,80,DEPT;医生备注,200;护士备注,200;急作,50,boolean;给付类别,80,INS_PAY
...
CTRL_TABLE.enHeader=Link;Group;OrderName;Qty;Unit;Freq;Route;Day;TotQty;PatPrep;Box;Unit;ExecDept;DrNote;NurseNote;Urgent;PayType
CTRL_TABLE.LanguageMap=ORDER_DESC|TRADE_ENG_DESC
...
tPanel_5.zhTitle=西、成药
tPanel_5.enTitle=Medicine
MED_TABLE.Type=TTable
MED_TABLE.X=8
MED_TABLE.Y=5
MED_TABLE.Width=970
MED_TABLE.Height=405
...
MED_TABLE.Header=连,30,boolean;组,40;医嘱,200;用量,60,double,##0.00;单位,40,UNIT_CODE;频次,50,FREQ_CODE;用法,80,ROUTE_CODE;日份,50,int,#0;总量,60,double;备,60,boolean;盒,30,boolean;单位,60,UNIT_CODE;执行科室,80,DEPT;医生备注,200;护士备注,200;急作,50,boolean;给付类别,80,INS_PAY
...
MED_TABLE.enHeader=Link;Group;OrderName;Qty;Unit;Freq;Route;Day;TotQty;PatPrep;Box;Unit;ExecDept;DrNote;NurseNote;Urgent;PayType
MED_TABLE.LocalTableName=
MED_TABLE.LanguageMap=ORDER_DESC|TRADE_ENG_DESC
...
OP_TABLE.Header=连,30,boolean;组,40,int;医嘱,200;用量,40,double,##0.00;单位,40,UNIT_CODE;频次,50,FREQ_CODE;日份,40,int,#0;总量,60,double;执行科室,80,OP_EXEC_DEPT;医生备注,200;护士备注,200;急作,50,boolean;给付类别,80,INS_PAY
...
OP_TABLE.enHeader=Link;Group;OrderName;Qty;Unit;Freq;Days;TotQty;ExecDept;DrNote;NurseNote;Urgent;PayType
OP_TABLE.LanguageMap=ORDER_DESC|TRADE_ENG_DESC
...
tPanel_3.zhTitle=检验检查
tPanel_3.enTitle=Lab
EXA_TABLE.Type=TTable
EXA_TABLE.X=5
EXA_TABLE.Y=7
EXA_TABLE.Width=973
EXA_TABLE.Height=403
EXA_TABLE.SpacingRow=1
EXA_TABLE.RowHeight=20
EXA_TABLE.AutoWidth=Y
EXA_TABLE.AutoHeight=Y
EXA_TABLE.Header=医嘱,200;数量,40,double;单位,40,UNIT_CODE;执行科室,80,TECH_DEPT;样本,80,OPTITEM_CODE;医生备注,200;护士备注,200;急作,50,boolean;给付类别,80,INS_PAY
...
EXA_TABLE.enHeader=Order;Quantity;Unit;Execut;Sample;Dr Notes;RN Notes;Urgent;Pay Type
EXA_TABLE.LanguageMap=ORDER_DESC|TRADE_ENG_DESC
WC.Type=TComboBox
WC.X=568
WC.Y=23
WC.Width=81
...
WC.showID=Y
WC.Editable=Y
WC.StringData=[[id,name,enname],[C,中医,ChnMed],[W,西医,Med]]
WC.ShowName=Y
WC.ShowText=N
...
DIAG_TABLE.X=414
DIAG_TABLE.Y=60
DIAG_TABLE.Width=584
DIAG_TABLE.Height=206
...
DIAG_TABLE.enHeader=Chn/Wst;Main;Diagnosis;Notes
DIAG_TABLE.LanguageMap=ICD_CHN_DESC|ICD_ENG_DESC
PHYSEXAM_REC.Type=TTextArea
PHYSEXAM_REC.X=73
PHYSEXAM_REC.Y=167
PHYSEXAM_REC.Width=332
...
tPanel_1.Border=组|就诊记录|Clinical History
tPanel_1.Item=TABLE;OPERATOR;tButton_0
...
TABLE.enHeader=Visit Date;Dr

CHN_TABLE.Type=TTable
CHN_TABLE.X=6
CHN_TABLE.Y=34
CHN_TABLE.Width=972
CHN_TABLE.Height=376
