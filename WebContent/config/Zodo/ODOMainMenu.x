<Type=TMenuBar>
UI.Item=File;Window
UI.button=save;|;fee;|;delete;|;clear;|;caseHistory;|;showpat;|;reg|;showPatDetail;|;toTemplate;|;ekt;|;AbnormalReg;|;mrshow;|;INSDrQuery;|;insMTRegister;|;searchFee;|;close
...
File.enText=File
File.M=F
File.Item=save;delete;Refresh;query;|;clear;|;mrshow;|;cxMrshow;|;showpat;|;INSDrQuery;|;close
