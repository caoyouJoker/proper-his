...
TABLE.SpacingRow=1
TABLE.RowHeight=20
TABLE.Header=成本中心代码,105;成本中心名称,120;简拼1,60;简拼2,60;英文名称,75;成本中心简拼,100;序号,40;区域代码,120,REGION_CODE;科室描述,70;最小科室,70,boolean;科室等级,70,combo|1:一级科室|2:二级科室|3:三级科室;科室归类,100,combo|0:临床科室|1:医技科室|2:药库科室|3:行政科室|4:煎药室;科室大分类,80,DEPT_CODE1;门诊,40,boolean;急诊,40,boolean;住院,40,boolean;健检,40,boolean;代表端末机,80;预设印表机,80;统计,40,boolean;启用,40,boolean
TABLE.AutoHeight=Y
TABLE.AutoWidth=Y
