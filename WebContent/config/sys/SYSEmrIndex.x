...
TABLE.AutoHeight=Y
TABLE.AutoSize=0
TABLE.Header=就诊序号,120;门急住别,80,ADM_TYPE;区域,120,REGION_CODE;住院号,120;病案号,120;看诊日(住院日),170,Timestamp,yyyy/MM/dd HH:mm:ss;科别,120,DEPT_CODE;医师,120,OPT;出院日期,120;操作者,80,OPT;操作时间,120;操作IP,120
