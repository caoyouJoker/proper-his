...
UI.button=save;|;sign;signCancel;|;ModifyFontCombo;ModifyFontSizeCombo;FontBMenu;FontIMenu;|;delFixText;|;ClearMenu;|;SavePatInfo;|;InsertLCSJ;|;InsertTemplatePY;|;specialChars;|;insertFixText;|;exit
...
InsWidget.M=I
InsWidget.Item=InsertCurrentTime;|;InsertTable;DelTable;InsertTableRow;AddTableRow;DelTableRow;|;insertFixText
...
InsertTemplatePY.Text=子模版
InsertTemplatePY.zhText=子模版
...
specialChars.Text=特殊字符
specialChars.Tip=特殊字符
specialChars.M=
specialChars.key=
specialChars.Action=onSpecialChars
specialChars.pic=027.gif
