...
UI.Height=227
UI.toolbar=Y
UI.controlclassname=com.javahis.ui.reg.REGSchWeekForDayControl
UI.item=tPanel_0;tButton_3;tButton_4;tButton_5
UI.layout=null
UI.FocusList=
UI.Border=
...
tButton_3.Height=23
tButton_3.Text=执行
tButton_3.Action=onSave
tPanel_0.Type=TPanel
tPanel_0.X=5
tPanel_0.Y=5
tPanel_0.Width=457
tPanel_0.Height=141
tPanel_0.Item=tLabel_0;tLabel_1;tLabel_2;REGION_CODE;tLabel_3;tLabel_4;tLabel_5;tLabel_6;ADM_TYPE;ADM_DATE_START;ADM_DATE_END;CLINICROOM_NO;DR_CODE
tPanel_0.Enabled=Y
tPanel_0.Border=凸
tPanel_0.AutoX=Y
...
DR_CODE.Dept=<CLINICROOM_NO>
DR_CODE.PosType=1
DR_CODE.HisOneNullRow=Y
CLINICROOM_NO.Type=科室
CLINICROOM_NO.X=106
CLINICROOM_NO.Y=85
CLINICROOM_NO.Width=104
...
CLINICROOM_NO.Tip=科室
CLINICROOM_NO.ShowColumnList=NAME
CLINICROOM_NO.FinalFlg=Y
CLINICROOM_NO.ClassIfy=0
CLINICROOM_NO.Action=DR_CODE|onQuery
CLINICROOM_NO.HisOneNullRow=Y
ADM_DATE_END.Type=TTextFormat
ADM_DATE_END.X=315
ADM_DATE_END.Y=26
ADM_DATE_END.Width=104
ADM_DATE_END.Height=20
ADM_DATE_END.Text=TTextField
ADM_DATE_END.showDownButton=Y
ADM_DATE_END.FormatType=date
ADM_DATE_END.Format=yyyy/MM/dd
ADM_DATE_START.Type=TTextFormat
ADM_DATE_START.X=106
ADM_DATE_START.Y=26
ADM_DATE_START.Width=104
ADM_DATE_START.Height=20
ADM_DATE_START.Text=TTextField
ADM_DATE_START.showDownButton=Y
ADM_DATE_START.FormatType=date
ADM_DATE_START.Format=yyyy/MM/dd
