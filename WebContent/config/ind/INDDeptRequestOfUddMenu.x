...
<Type=TMenuBar>
UI.Item=File;Window
UI.button=save;|;query;|;clear;|;printM;|;printD;|;printRecipe;|;export;|;close
...
File.Text=文件
File.M=F
File.Item=save;|;query;|;clear;|;printM;|;printD;|;printRecipe;|;export;|;close
