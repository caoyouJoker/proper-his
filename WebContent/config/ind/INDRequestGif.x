...
<Type=TFrame>
UI.Title=拨补作业
UI.MenuConfig=%ROOT%\config\ind\INDRequestGifMenu.x
UI.Width=1024
UI.Height=748
UI.toolbar=Y
UI.controlclassname=com.javahis.ui.ind.INDRequestGifControl
...
TABLE_D.AutoX=Y
TABLE_D.AutoSize=0
TABLE_D.Header=药品名称,200;规格,150;转出数量,80,double,#####0.000;单位,40,UNIT;零售价,100,double,#####0.0000;零售金额,120,double,#####0.00;累计完成量,100,double,#####0.000;中止,40,boolean
...
tPanel_8.Item=tLabel_0;SUM_RETAIL_PRICE;UNIT
UNIT.Type=计量单位下拉列表
UNIT.X=357
UNIT.Y=48
UNIT.Width=10
...
TABLE_M.AutoSize=0
TABLE_M.Header=调拨日期,100;调拨单号,100;单据类别,100,REQTYPE_CODE;转出部门,100,APP_ORG_CODE;申请人员,100,REQUEST_USER;转入部门,100,TO_ORG_CODE;拨补原因,100,REASON_CHN_DESC;单位,80,UNIT_TYPE;备注,150;急,30,boolean
...
tPanel_0.Border=组
tPanel_0.Item=tLabel_1;UPDATE_FLG_A;UPDATE_FLG_B;tLabel_2;REQUEST_DATE;tLabel_3;APP_ORG_CODE;tLabel_4;REQUEST_NO;tLabel_5;REQTYPE_CODE;tLabel_9;TO_ORG_CODE;tLabel_11;tLabel_12;DESCRIPTION;URGENT_FLG;tLabel_8;START_DATE;tLabel_14;END_DATE;REASON_CHN_DESC;UNIT_TYPE;REQUEST_USER
...
REQTYPE_CODE.StringData=[[id,name],[GIF,药房调拨]]
REQTYPE_CODE.SelectedAction=
REQTYPE_CODE.Action=onChangeRequestType
