...
<Type=TFrame>
UI.Title=自动拨补部门
UI.MenuConfig=%ROOT%\config\ind\INDAssignorgMenu.x
UI.Width=1024
UI.Height=748
UI.toolbar=Y
UI.controlclassname=com.javahis.ui.ind.INDAssignorgControl
...
TABLE.AutoHeight=Y
TABLE.AutoSize=0
TABLE.Header=拨补部门,120,ORG_CODE;循环方式,100,CYCLE_TYPE;操作人员,100;操作时间,120;操作IP,100
...
TABLE.Item=ORG_CODE;CYCLE_TYPE
...
tPanel_0.Item=tLabel_0;tLabel_1;CYCLE_TYPE;Panel_M;Panel_W;ORG_CODE
ORG_CODE.Type=药房
ORG_CODE.X=100
ORG_CODE.Y=15
ORG_CODE.Width=144
